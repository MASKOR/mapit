...
public:
     ...
     */
    virtual mapit::istream *startRead(mapit::uint64_t start = 0, mapit::uint64_t len = 0) = 0;
    /**
     ...
     */
    virtual mapit::ostream *startWrite(mapit::uint64_t start = 0, mapit::uint64_t len = 0) = 0;
    /**
     ...
     * @return a stream to read data from
     */
    virtual const void *startReadPointer(ReadWriteHandle &handle, mapit::uint64_t start = 0, mapit::uint64_t len = 0 ) = 0;
     ...
     * @return a stream to read data from
     */
    virtual void *startWritePointer(ReadWriteHandle &handle, mapit::uint64_t start = 0, mapit::uint64_t len = 0 ) = 0;
    ...
    virtual mapit::uint64_t getStreamSize() const = 0;

    virtual void setStreamSize(mapit::uint64_t) = 0;
