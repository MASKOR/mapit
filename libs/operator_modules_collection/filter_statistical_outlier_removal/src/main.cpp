...
upns::StatusCode operateStatisticalOutlierRemoval(upns::OperationEnvironment* environment)
{
    ...
    try {
        func(*original, *filtered, deviation, neighbors);
    } catch(...) {
