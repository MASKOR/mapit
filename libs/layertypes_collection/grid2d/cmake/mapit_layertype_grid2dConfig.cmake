...
#target_include_directories(mapit::layertype_grid2d ${PCL_INCLUDE_DIRS})
...
if(NOT TARGET mapit::layertype_grid2d AND NOT mapit::layertype_grid2d_BINARY_DIR)
  include("${MAPIT_CORE_CMAKE_DIR}/mapit_layertype_grid2dTargets.cmake")
