...
./mapit-execute --yaml repo.yaml testcheckout load_pointcloud "{\"filename\":\"$HOME/develop/mapit/tools/Qt3DPointcloudRenderer/example/data/bunny.pcd\", \"target\":\"corridor/laser/eins\"}"
