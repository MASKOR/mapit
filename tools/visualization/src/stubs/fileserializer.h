...
public:
    ...
    StatusCode storeTree(upnsSharedPointer<Tree> &obj);
    ...
    StatusCode storeEntity(upnsSharedPointer<Entity> &obj);
    ...
    StatusCode createCommit(upnsSharedPointer<Commit> &obj);
